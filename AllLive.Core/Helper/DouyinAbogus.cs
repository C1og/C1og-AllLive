...
namespace AllLive.Core.Helper
{
    public static class DouyinAbogus
    {
        ...
        private static string GenerateMsToken(int length = 184)
        {
            ...
            {
                var index = RandomUtil.Next(baseStr.Length);
    ...
    internal static class BrowserFingerprintGenerator
    {
        ...
        {
            var innerWidth = 1024 + RandomUtil.Next(1920 - 1024 + 1);
            var innerHeight = 768 + RandomUtil.Next(1080 - 768 + 1);
            var outerWidth = innerWidth + (24 + RandomUtil.Next(32 - 24 + 1));
            var outerHeight = innerHeight + (75 + RandomUtil.Next(90 - 75 + 1));
            var screenX = 0;
            var screenY = RandomUtil.Next(2) == 0 ? 0 : 30;
            var sizeWidth = 1024 + RandomUtil.Next(1920 - 1024 + 1);
            var sizeHeight = 768 + RandomUtil.Next(1080 - 768 + 1);
            var availWidth = 1280 + RandomUtil.Next(1920 - 1280 + 1);
            var availHeight = 800 + RandomUtil.Next(1080 - 800 + 1);
